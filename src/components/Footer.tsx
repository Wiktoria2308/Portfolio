  ...
  return (
    <footer className="bg-gray-400 py-16 relative">
      ...
      <div className="text-center mt-8">
        <p className="text-lg tracking-wide"><span className="uppercase text-gray-700">By Wiktoria Dobrzewinska </span><span className="text-fuchsia-800 text-2xl font-extrabold">©2023</span></p>
      </div>
            <div className="text-center mt-8">
